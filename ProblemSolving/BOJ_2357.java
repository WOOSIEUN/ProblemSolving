...
public class BOJ_2357 {
	...
	public static void main(String[] args) throws IOException {
		...
		MaxSegmentTree maxSegmentTree = new MaxSegmentTree(N, arr);
		...
		for (int i = 0; i < M; i++) {
			...
			maxSegmentTree.initMax();
			maxSegmentTree.query(a, b, 1, 0, N - 1);
			
			sb.append(minSegmentTree.getMin()).append(" ").append(maxSegmentTree.getMax()).append("\n");
		}
